...
public class ActivityAnalyser {
	 ...
	 */
	public void loadPie(Method datatype, int threshold, PieChart chart) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		Platform.runLater(new Runnable() {
			@Override
			public void run() {
				Utils.setPieChart(Utils.hashmapToPieChartData(map, threshold, 0), chart);
			}
		});
	}
